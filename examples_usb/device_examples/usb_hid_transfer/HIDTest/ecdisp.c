...
//    the two functions were melded together into one for purpose of execution
*/
...
--*/
{
    ...
    //   string are terminated with a NULL character if there was space within
...
RoutineDescription:
    ...
    parameter for a given function call, setting up the CallParameters structure
...
--*/
{
    ...
    */
    ...
    /*
    // Parameters are now set up and ready to go, let's execute
    */
...
RoutineDescription:
    ...
    be expressed as hexadecimal numbers.
--*/
{
